<aura:application extends="force:slds" controller="AccountController1">
    ...
    <lightning:button variant="brand" label="Fetch Accounts" class="slds-button slds-button--neutral" onclick="{!c.getAccounts}"></lightning:button>
